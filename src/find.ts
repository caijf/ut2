...
function find<T>(collection: WithNullable<T[]>, predicate?: ArrayIterator<T, any>): T | undefined;
function find(collection: WithNullable<string>, predicate?: StringIterator<any>): string | undefined;
function find<T>(collection: WithNullable<ArrayLike<T>>, predicate?: ArrayLikeIterator<T, any>): T | undefined;
function find<T extends object>(collection: WithNullable<T>, predicate?: ObjectIterator<T, any>): T[keyof T] | undefined;
 ...
 */
function find(collection: any, predicate: any = identity) {
  let result: any;
